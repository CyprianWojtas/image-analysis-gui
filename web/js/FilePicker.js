...
export default class FilePicker extends EventTarget {
    constructor() {
        super();
        this.dirsListBox = createElement("div", { class: "dirsListBox" });
        this.filesListBox = createElement("div", { class: "filesListBox" });
        this.pathEl = createElement("div", { class: "path" });
        this.fileNameInput = createElement("input", { placeholder: "New file name" });
        this.dirNameInput = createElement("input", { placeholder: "Directory name" });
        ...
        this.createDirBox = createNodeTree({
            name: "div",
            class: "createDirBox",
            childNodes: [
                this.dirNameInput,
