...
const J = t, Y = a, ee = Symbol("nomatch"), ne = t => {
    ...
    function f(e, t, i, r) {
        ...
        try {
            ...
            return S.finalize(), k = S.toHTML(), { language: e,
                value: k, relevance: C, illegal: !1, _emitter: S, _top: x };
        }
        catch (n) {
            if (n.message && n.message.includes("Illegal"))
                return { language: e, value: J(t),
                    illegal: !0, relevance: 0, _illegalBy: { message: n.message, index: T,
                        context: t.slice(T - 100, T + 100), mode: n.mode, resultSoFar: k }, _emitter: S };
            if (s)
                return {
    ...
    "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", (() => {
        N && w();
    }), !1), Object.assign(t, { highlight: h, highlightAuto: E, highlightAll: w,
        highlightElement: y,
        ...
        s = !1;
    }, t.safeMode = () => { s = !0; }, t.versionString = "11.9.0", t.regex = { concat: b,
...
function Oe(e) {
    const n = e.regex, t = _e, a = { begin: /<[A-Za-z0-9\\._:-]+/,
...
var Ke = Object.freeze({ __proto__: null, grmr_bash: e => {
        const n = e.regex, t = {}, a = {
    ...
    grmr_lua: e => {
            ...
            return n.concat(n.concat("(?:", e, ")"), a, /(?:\\.|[^\\\/])*?/, r, /(?:\\.|[^\\\/])*?/, i, t);
                ...
                contains: [e.HASH_COMMENT_MODE, { className: "regexp", variants: [{
                        ...
                        className: "regexp", variants: [{ begin: /(m|qr)\/\//, relevance: 0 }, {
                                begin: d("(?:m|qr)?", /\//, /\//)
                            }, { begin: d("m|qr", n.either(...l, { capture: !0
        ...
        }, p = e => e.map((e => e.replace(/\|\d+$/, ""))), _ = { variants: [{
    ...
    grmr_scss: e => {
        const n = ie(e), t = le, a = oe, i = "@[a-z-]+", r = { className: "variable",
        ...
        }, F = { match: [/operator/, /\s+/, Be], className: {
                1: "keyword", 3: "title"
            } }, U = { begin: [/precedencegroup/, /\s+/, Ue], className: {
                1: "keyword", 3: "title"
